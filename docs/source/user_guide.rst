...
Now that you have a working installation, two options are possible: either there is already a plugin a doing exactly what you need, or most probably, you need to build your own daq_move or daq_viewer.
